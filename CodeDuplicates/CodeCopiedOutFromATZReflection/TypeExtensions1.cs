...
namespace ATZ.Reflection
{
    ...
    /// </summary>
    public static class TypeExtensions1
    {
        [NotNull]
        ...
        public static Type CloseTemplate([NotNull] this Type type, Type[] typeArguments)
        {
            ...
            var genericTypeParameters = GetGenericTypeParameters(type);
        ...
        {
            return type.Name.Replace($"`{GenericTypeParameterCount(type)}", "");
        }
        ...
        public static string ParameterizedGenericName([NotNull] this Type type, Type templateArgument)
        {
            ...
            {
                return NonGenericName(type);
            }

            var contravariantModifier = IsContravariant(genericTypeParameters[0]) ? "in " : "";

            return $"{NonGenericName(type)}{{{contravariantModifier}{templateArgument.Name}}}";
        }
